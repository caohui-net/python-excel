...
# 1. 读取excel文档
testpath =r'C:\Users\Administrator\Documents\GitHub\python-sql\python-excel\study_openpyxl\test.xlsx'
wb = openpyxl.load_workbook(testpath)
...
sheet.cell(row=3, column=2).value = 'wwww'
